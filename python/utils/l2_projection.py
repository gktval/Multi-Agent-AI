...
def distribution(next_distr_v, rewards_v, dones_mask_t, gamma, delta_z, n_atoms, v_min, v_max):
    next_distr = next_distr_v.data.cpu().numpy()
    rewards = rewards_v.data.cpu().numpy().squeeze()
    dones_mask = dones_mask_t.cpu().numpy().astype(np.bool).squeeze()
